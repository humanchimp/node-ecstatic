...
export const setCustomGetType = fn => {
  customGetType = fn;
};

export const getType = (file, defaultValue) =>
  customGetType(file, defaultValue) || mime.getType(file) || defaultValue;

let customLookupCharset = mimeType => null; // eslint-disable-line no-unused-vars

export const setCustomLookupCharset = fn => {
  customLookupCharset = fn;
};

export const lookupCharset = mimeType =>
  customLookupCharset(mimeType) || charset(mimeType);
